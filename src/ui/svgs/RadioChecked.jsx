...
/**
 * Documentation
 * @param {RadioChecked} radioChecked - {@link radioChecked} object
 */
function RadioChecked({ width, height }) {
    return (
        <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <circle cx="12" cy="12" r="5.25" fill="var(--color-brand-800)" />
        </svg>
    );
}
